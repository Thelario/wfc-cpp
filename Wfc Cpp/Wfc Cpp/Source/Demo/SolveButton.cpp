...
namespace Demo
{
	SolveButton::SolveButton(glm::vec2 position, glm::vec2 scale, double rotation, const std::string& texture_id, int width, int height,
	...
	void SolveButton::OnMouseEnter()
	{
		scale = glm::vec2(.9);
	}

	void SolveButton::OnMouseExit()
	{
		scale = glm::vec2(.75);
	}

	void SolveButton::OnMouseStay()
	{
